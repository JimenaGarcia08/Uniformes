...
const MovimientosScreen = () => {
  ...
  const handleRegistrarMovimiento = async () => {
    ...
    try {
      // Llamar a Firebase para registrar el movimiento
      ...
      Alert.alert(
        'Éxito',
        `${movimientoTipo === 'entrada' ? 'Entrada' : 'Salida'} registrada correctamente\n` +
        `Nuevo stock: ${resultado.nuevaCantidad} unidades`,
        [{ text: 'OK', onPress: () => {
                ...
                <HStack space="md" alignItems="flex-start">
                  ...
                  <VStack flex={1}>
                    ...
                    <Text style={styles.fechaText}>
                       {mov.fechaString} | {mov.usuario}
                    </Text>
                    {mov.cantidadAnterior !== undefined && (
                      <Text style={styles.stockText}>
                        Stock: {mov.cantidadAnterior} → {mov.cantidadNueva}
                      </Text>
                    )}
                  </VStack>
                </HStack>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <VStack space="lg" paddingBottom="$4">
                ...
                <VStack space="xs">
                  ...
                  <HStack space="md">
                    <TouchableOpacity
                      style={[
                        styles.tipoButton,
                        movimientoTipo === 'entrada' && styles.tipoButtonActiveEntrada
                      ]}
                    ...
                    >
                      <Ionicons 
                        name="arrow-down" 
                        size={20} 
                        color={movimientoTipo === 'entrada' ? '#ffffff' : '#10b981'} 
                      />
                      <Text style={[
                        styles.tipoButtonText,
                        movimientoTipo === 'entrada' && styles.tipoButtonTextActive
                      ]}>Entrada</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      style={[
                        styles.tipoButton,
                        movimientoTipo === 'salida' && styles.tipoButtonActiveSalida
                      ]}
                    ...
                    >
                      <Ionicons 
                        name="arrow-up" 
                        size={20} 
                        color={movimientoTipo === 'salida' ? '#ffffff' : '#ef4444'} 
                      />
                      <Text style={[
                        styles.tipoButtonText,
                        movimientoTipo === 'salida' && styles.tipoButtonTextActive
                      ]}>Salida</Text>
                    </TouchableOpacity>
                  </HStack>
                </VStack>
                ...
                {/* Producto */}
                <VStack space="xs">
                  <Text style={styles.label}>Producto / Inventario *</Text>
                  <Select
                    selectedValue={formData.inventarioId}
                    onValueChange={(value) => {
                      setFormData({...formData, inventarioId: value});
                    }}
                  >
                ...
                {/* Usuario */}
                <VStack space="xs">
                  <Text style={styles.label}>Usuario/Cliente</Text>
                  <Input variant="rounded" size="md" style={styles.modalInput}>
                    <InputField
                      placeholder="Nombre de quien recibe o entrega"
                ...
                <HStack space="md" marginTop="$4">
                  ...
                  <Button
                    ...
                    style={[
                      ...
                      movimientoTipo === 'entrada' ? styles.modalSubmitEntrada : styles.modalSubmitSalida
                    ]}
